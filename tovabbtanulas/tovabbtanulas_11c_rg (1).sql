...
--
-- Gép: 127.0.0.1
-- Létrehozás ideje: 2023. Okt 17. 09:35
...
--
-- Tábla szerkezet ehhez a táblához `kozeipskola`
--

CREATE TABLE `kozeipskola` (
...
--
-- A tábla adatainak kiíratása `kozeipskola`
--

INSERT INTO `kozeipskola` (`id_kozepiskola`, `kozepiskola_neve`, `kozepiskola_cime`) VALUES
...
--
-- A tábla indexei `kozeipskola`
--
ALTER TABLE `kozeipskola`
...
--
-- AUTO_INCREMENT a táblához `kozeipskola`
--
ALTER TABLE `kozeipskola`
